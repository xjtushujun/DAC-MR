...
class IncrementalLoader:
    ...
    def _get_loader(self, x, y, shuffle=True, mode="train"):
        if mode == "train":
            ...
            trsf1 = transforms.Compose([*self.train_transforms, *self.common_transforms])
            trsf2 = transforms.Compose([*self.train_transforms, *self.strong_transforms, *self.common_transforms])
            trsf = TransformFix(trsf1, trsf2)
